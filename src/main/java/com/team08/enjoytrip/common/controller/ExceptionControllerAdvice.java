package com.team08.enjoytrip.common.controller;

import com.team08.enjoytrip.common.dto.ErrorDetail;
import com.team08.enjoytrip.common.dto.ErrorResponseDto;
...
public class ExceptionControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleExceptionInternal(
        ...
        return ResponseEntity.status(status).headers(headers).body(new ErrorResponseDto(ex.getMessage(), errorDetail));
    }
